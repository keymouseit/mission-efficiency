...
interface FAQSectionData {
  field_cta_faq_title?: string;
  field_cta_faq_subtitle?: { processed?: string };
  field_cta_faq_left_title?: string;
  field_cta_faq_left_cards?: DrupalNode[];
  field_cta_faq_right_title?: string;
  field_cta_faq_right_cards?: DrupalNode[];
}
...
function FAQSectionClient({ data }: FAQSectionProps) {
  const {
    field_cta_faq_title,
    field_cta_faq_subtitle,
    field_cta_faq_left_title,
    field_cta_faq_left_cards,
    field_cta_faq_right_title,
    field_cta_faq_right_cards,
  } = data;
  ...
  return (
    ...
    >
      ...
      <div className="mini-container h-full">
        ...
        {/* Subtitle */}
        {field_cta_faq_subtitle?.processed && (
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            dangerouslySetInnerHTML={{
              __html: field_cta_faq_subtitle.processed,
            }}
          />
        )}
        ...
        >
          ...
          <motion.div className="remove-animation-fluctuation w-[49%] laptopMax:w-full laptopMax:mb-5">
            ...
            <div className="mt-4">
              {field_cta_faq_left_cards?.map((card, index) => (
                <Accordion
                  key={`left-faq-${index}`}
                  type="single"
                  collapsible
                  ...
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html:
                            card?.field_cta_faq_description?.processed || "",
                        }}
                      />
                    </AccordionContent>
                  </AccordionItem>
          ...
          <motion.div className="remove-animation-fluctuation w-[49%] laptopMax:w-full laptopMax:mb-5">
            ...
            <div className="mt-4">
              {field_cta_faq_right_cards?.map((card, index) => (
                <Accordion
                  key={`right-faq-${index}`}
                  type="single"
                  collapsible
