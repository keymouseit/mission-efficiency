...
import { verifyCaptchaAction } from "@/lib/CaptchaService";
            ...
            return (
              <div className="mb-8 mx-1" key={index}>
                ...
                <CommonReactSelect
                  ...
                  list={selectList}
                  isPlanStyle={true}
                  // {...register(selectInput?.field_form_field_key_name as any)}
                  // selectorName={selectInput?.field_form_field_key_name}
                  onSelectChange={(value) => {
