          ...
          {data?.field_add_card?.length > 0 && (
            <div className="grid grid-cols-1 tab:grid-cols-2 laptop:grid-cols-3 gap-5 mt-10 w-full">
              {data.field_add_card.map((dropdownCard: any, index: number) => {
                const bgColor = dropdownCard?.field_background_color;
                const bgClass =
                  bgColor === "blue"
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <h4
                        className={`w-full flex items-center justify-center h-[100px] px-[15px] text-numans uppercase text-center text-[22px] leading-normal mobileMax:text-medium font-semibold ${
                          bgColor === "blue"
                            ? "text-[#9af9ff]"
                            : "text-lightBlue"
                        }`}
                        ...
                        >
                          ...
                          >
                            <motion.li variants={itemVariant}>
                              <div
                                className={`${descriptionColor} cursor-pointer underline text-left select-none block --font-poppins text-[18px] mb-3 leading-normal mobileMax:w-full mobileMax:text-xsmall mobileMax:leading-normal`}
                                dangerouslySetInnerHTML={{
                                  __html:
                                    dropdownCard?.field_description
                                      ?.processed || "",
                                }}
                              />
                            </motion.li>
