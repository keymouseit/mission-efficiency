...
import { createQueryString, getAlpha2FromISO } from "@/utils";
import NextBreadcrumb from "@/components/sections/NextBreadcrumb";
import { CardContent, CardFooter, CardHeader, Cards, CardTitle } from "@/components/ui/Cards";
import CommonReactSelect from "@/components/sections/CommonReactSelect";
import { Button } from "@/components/ui/Button";
import CustomisableTable from "@/components/sections/CustomisableTable";
import MobileToolsList from "@/components/sections/MobileToolList";
  ...
  return (
    <div className="parent-card-container">
      ...
      <div className="card-container">
        <Cards className="w-full px-6 py-4 innerPage-card-height mobileMax:p-0">
