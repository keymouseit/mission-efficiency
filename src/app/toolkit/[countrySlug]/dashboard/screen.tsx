...
import { createQueryString, findRegionFromISO, getAlpha2FromISO, getColorFromStat, getSectorByEfficiency } from "@/utils";
import { CONSTS } from "@/constants";
import CommonReactSelect from "@/components/sections/CommonReactSelect";
import { Button } from "@/components/ui/Button";
import NextBreadcrumb from "@/components/sections/NextBreadcrumb";
import OverAllCountryTable from "@/components/sections/OverAllCountryTable";
import PotentialIndicator from "@/components/sections/PotentialIndicator";
import LegendsModal from "@/components/sections/LegendsModal";
            ...
            <div className="flex items-start laptopMax:block">
              <div className="flex flex-col items-center mb-5 country-details-header w-1/2 pr-8 pt-0 laptopMax:w-full laptopMax:pr-0">
                <div className="mb-6 text-base flex items-center justify-start w-full mobileMax:mb-2">
                  <Cards className="country-card border-none shadow-none w-full max-w-[62px] h-[62px] mobileMax:max-w-[50px] mobileMax:max-h-[50px] mobileMax:w-[50px] mobileMax:w-[50px] rounded-full overflow-hidden common-dropShadow">
                    {countryCode ? (
                      <Image
